...
Page({
  ...
  myImg() {
    ...
    wx.previewImage({
      current: '',
      urls: ['https://p9.pstatp.com/aweme/300x400/81a9000bf5a6709deddc.jpeg']
    })
    if (wx.saveImageToPhotosAlbum) {
      wx.saveImageToPhotosAlbum({
        filePath: 'https://p9.pstatp.com/aweme/300x400/81a9000bf5a6709deddc.jpeg'
      })
    }
  },
  /**
  ...
  onShow() {
    ...
    animation.scale(2, 2).rotate(135).step()
  ...
  // 单独一个元素的动画集
  clickRedTap: function() {
    var index = this.data.index;
    this.animation.rotate(index * 30).scale(index * 0.5).step();
    this.animation.translate(index * 30, index * -30).step({ duration: 1000 })
    this.setData({
